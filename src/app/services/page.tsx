...
export default function ServicesPage() {
  ...
  return (
    <main className="bg-black text-white min-h-screen font-sans" style={{ overflowX: 'clip' }}>
      <Header />
            ...
            >
              <div className="h-screen w-full flex items-center justify-center relative">
                ...
                <div className="relative w-full max-w-[1400px] px-6 sm:px-10 lg:px-20 xl:px-24 pointer-events-auto">
                  ...
                  <p className="text-sm md:text-xl text-white/90 max-w-md md:max-w-2xl leading-snug font-medium drop-shadow-md">{item.description}</p>
                </div>
                ...
                {i === SERVICES_DATA.length - 1 && (
                  <div className="absolute bottom-10 left-6 md:bottom-12 md:left-16 max-w-[calc(100%-48px)] md:max-w-md pointer-events-auto z-20">
                    ...
                    >
                      <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="rotate-180 transition-transform group-hover:-translate-x-1">
